...
https://bmlip.github.io/course/lectures/Density%20Estimation.html#natural-parameterization
...
- A URL pointing to this course website. Like https://bmlip.github.io/course/lectures/Density%20Estimation.html#natural-parameterization In this case, we don't check the internet, but we check locally if that path will exist, given the new directory structure.
