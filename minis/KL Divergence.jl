...
# ╔═╡ 8f1a66b0-6a52-4eba-bc1f-0dd99eb91cb9
using BmlipTeachingTools, Plots, Plots.PlotMeasures, StatsPlots, LaTeXStrings, Distributions

# ╔═╡ acdc5f8b-e79b-475f-95d8-f9623a705c9e
title("Mini: The Kullback-Leibler Divergence")

# ╔═╡ e39fd1e2-cbba-48ad-a5f7-733a229be257
md"""
## 
...
# ╔═╡ 3c655528-77f5-4327-9a0b-1e0a7a27474b
md"""
## Interactive Example
...
# ╔═╡ 4d4e9bb3-41ef-4185-9930-1628220c6552
...
# ╔═╡ 371e4d9b-99d9-412b-8648-b19f9bfad216
md"""
Statistics of the distribution ``p`` that we keep constant, the mean of ``q`` is interactive. _Feel free to edit the code to change more parameters._
"""

# ╔═╡ ec537d0f-b127-4512-a743-f374fed7e2a2
p = Normal(0.0, 1.0);

# ╔═╡ c9702675-e665-49ff-a86a-47b88d7269cb


# ╔═╡ ea709a1e-ae4a-4306-8ed6-656a90b1e014
md"""
#### Behind the scenes
"""

# ╔═╡ 2e9f5142-67fd-4098-90b1-f75f05565d98
μ_seq = -5.0 : 0.1 : 5.0;

# ╔═╡ 9834138c-3370-4ba5-a28c-8d74f90869ca
@bindname μ_q Slider(μ_seq; show_value=true)

# ╔═╡ f715e333-a787-40ff-99d9-a2bf75385315
q = Normal(μ_q, 1.0);

# ╔═╡ 1f8d33a3-aeda-45a7-a343-ab3565ace9ae
kl = [kullback_leibler(Normal(μ, q.σ), p) for μ in μ_seq]

# ╔═╡ 62694615-197c-4c2c-8365-c1f6cb974564
let
	plot(
		; 
		right_margin=8mm, 
		title=string(L"D_{KL}(Q || P) = ", round(100 * kullback_leibler(p,q)) / 100.), 
		legend=:topleft,
	)
...
manifest_format = "2.0"
project_hash = "fb4de5cc65c96d38ad6e2b1185e2cf4d1556f22d"
