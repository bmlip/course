...
In the Regression lecture, we will try to approximate a function using [radial basis functions](https://en.wikipedia.org/wiki/Radial_basis_function). This means we have a fixed set of basis functions and approximate our function as a linear combination of them.
...
manifest_format = "2.0"
project_hash = "930c4b32af3280bc6efe53d879b8d5e4bdd251b8"
