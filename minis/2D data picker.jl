...
init = let
	...
	ts = map(enumerate([g1, g2, g3])) do (i, xs)
		[(x..., i) for x in eachcol(xs)]
	end
	union(ts...)
end
...
"""
	...
	PlutoUI.Experimental.transformed_value(identity, h; get_initial_value=() -> collect.(initial_data))
end
...
manifest_format = "2.0"
project_hash = "6b0309fcc826216d54d787278061680c9cac4b09"
